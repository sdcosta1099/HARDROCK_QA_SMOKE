...
test('UH-16855 Halo | Visit Appeasement | Visit Appeasement Report search by patron id', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.CommentTestAccounts.UH16855)
