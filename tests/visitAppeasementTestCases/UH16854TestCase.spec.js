...
test('UH-16854 Halo | Visit Appeasement | Visit Appeasement Report search by Property Ids', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.CommentTestAccounts.UH16854)
