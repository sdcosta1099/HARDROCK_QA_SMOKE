...
test('UH-16853 Halo | Visit Appeasement | Visit Appeasement Report search by date ( transaction', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.CommentTestAccounts.UH16853)
