...
test('UH-9880 HALo|Check-In|Test | Modify Check In - Items: NO | Attendance: YES | Backup: YES - Backup was selected - Single and Multi Attendees', async ({ page }) => {
     
    const gblFuntSteps = new globalFUnctionSteps(page)
    const searchPlayerID= new playerSearchSteps(page)
    const configSteps= new configurationSteps(page)
    //generate random Offer name
    const offerName = gblFuntSteps.randomName('UH-9880')
    //login steps
