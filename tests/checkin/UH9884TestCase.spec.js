...
test('UH-9884 HALo|Check-In|Test |Override to Check In - Items: NO | Attendance: YES | Backup: YES - Capacity Not Avail. - Booked in advance - Single and Multi Seg Max Attendee Qty', async ({ page }) => {
     
    const gblFuntSteps = new globalFUnctionSteps(page)
    const searchPlayerID= new playerSearchSteps(page)
    const configSteps= new configurationSteps(page)
    //generate random Offer name
    const offerName = gblFuntSteps.randomName('UH-9884')
    //login steps
