...
test(' UH-9876 HALo|Check-In|Test |Check In - Items: NO | Attendance: YES | Backup: YES - Capacity Avail. - Booked in advance - Single and Multi Attendees', async ({ page }) => {
     
    const gblFuntSteps = new globalFUnctionSteps(page)
    const searchPlayerID= new playerSearchSteps(page)
    const configSteps= new configurationSteps(page)
    //generate random Offer name
    const offerName = gblFuntSteps.randomName('UH-9876')
    //login steps
