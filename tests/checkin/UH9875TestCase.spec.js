...
test('UH-9875 HALo|Check-in|Check In - Items: NO | Attendance: YES | Backup: YES - Capacity Avail. - Not booked in advance - Single and Multi Attendees', async ({ page }) => {
     
    const gblFuntSteps = new globalFUnctionSteps(page)
    const searchPlayerID= new playerSearchSteps(page)
    const configSteps= new configurationSteps(page)
    //generate random Offer name
    const offerName = gblFuntSteps.randomName('UH-9875')
    //login steps
