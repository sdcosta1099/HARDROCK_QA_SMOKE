...
test('UH-9930 HALO | Check-In | Override to Modify Check-In - Item: YES | Attendance: YES | Back-Up: YES - Single Item - Not Booked in Advance', async ({ page }) => {
     
    const gblFuntSteps = new globalFUnctionSteps(page)
    const searchPlayerID= new playerSearchSteps(page)
    const configSteps= new configurationSteps(page)
    //generate random Offer name
    const offerName = gblFuntSteps.randomName('UH-9930')
    //login steps
