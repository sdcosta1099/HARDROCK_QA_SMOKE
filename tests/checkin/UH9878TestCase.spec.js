...
test('UH-9878 HALo|Check-In|Items: NO | Attendance: YES | Backup: YES - Capacity NOT Avail. - Booked for Attendance - Single and Multi Seg Max Attendee Qty', async ({ page }) => {
     
    const gblFuntSteps = new globalFUnctionSteps(page)
    const searchPlayerID= new playerSearchSteps(page)
    const configSteps= new configurationSteps(page)
    //generate random Offer name
    const offerName = gblFuntSteps.randomName('UH-9878')
    //login steps
