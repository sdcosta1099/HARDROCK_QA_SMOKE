...
test('UH-9877 HALo|Check-in|Check In - Items: NO | Attendance: YES | Backup: YES - Capacity NOT Avail. - Not booked in advance - Single and Multi Attendees', async ({ page }) => {
     
    const gblFuntSteps = new globalFUnctionSteps(page)
    const searchPlayerID= new playerSearchSteps(page)
    const configSteps= new configurationSteps(page)
    //generate random Offer name
    const offerName = gblFuntSteps.randomName('UH-9877')
    //login steps
