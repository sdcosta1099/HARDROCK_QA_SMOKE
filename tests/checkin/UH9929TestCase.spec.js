...
test('UH-9929 HALO | Check-In | Override to Modify Check-In - Item: YES | Attendance: YES | Backup: YES - Multi Item - Not Booked in Advance ', async ({ page }) => {
     
    const gblFuntSteps = new globalFUnctionSteps(page)
    const searchPlayerID= new playerSearchSteps(page)
    const configSteps= new configurationSteps(page)
    //generate random Offer name
    const offerName = gblFuntSteps.randomName('UH-9929')
    //login steps
