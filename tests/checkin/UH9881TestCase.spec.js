...
test(' UH-9881 HALo|Check-in|Modify Check In - Items: NO | Attendance: YES | Backup: YES - Attendance was selected - Single and Multi Attendees ', async ({ page }) => {
     
    const gblFuntSteps = new globalFUnctionSteps(page)
    const searchPlayerID= new playerSearchSteps(page)
    const configSteps= new configurationSteps(page)
    //generate random Offer name
    const offerName = gblFuntSteps.randomName('UH-9881')
    //login steps
