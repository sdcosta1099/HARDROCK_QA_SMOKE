...
test('UH_9457 Testing Check-In Multiple Attendees and Max Prize quantity set to 1 and Primary Item Available as 3', async ({ page }) => {
  ...
  await pa.SelectfillOutNewEventFields4("Smoke_UH_9457")
  ...
  await pa.enterOfferName("Smoke_UH_9457")
  ...
  await pa.searchEventInCheckin('Smoke_UH_9457')
  await pa.selectEventInCheckin('Smoke_UH_9457')
