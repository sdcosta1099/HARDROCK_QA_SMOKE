...
test('Select Existing Address as Shipping Address', async ({ page }) => {
    ...
    await pa.validateByDefaultShippingAddressSelectedAsBillingAddress()
    await pa.validatePaymentPage()
    await pa.validatePaymentPageFirstName()
    await pa.vailidatePaymentPageLastName()
    await pa.vailidatePaymentPageAddress1()
    await pa.vailidatePaymentPageAddress2()
    await pa.vailidatePaymentPageCountry()
    await pa.vailidatePaymentPageState()
    await pa.validatePaymentPageCity()
    await pa.validatePaymentPageZipCode()
    await pa.validatePaymentPagePhoneNumber()
