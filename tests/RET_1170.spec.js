...
test('Guest User PayPal Buy Now | Bag | International Orders |', async () => {
  ...
  await pa.selectCountry({label :'Italy'});
  await page.waitForTimeout(2000);
  await page.locator('//input[@id="stateCode"]').first().fill('Lombardy')
  await page.waitForTimeout(2000);
  await pa.enterCity('Milan')
  await pa.enterPinCode('20121') 
  ...
  await page.locator('//span[@class="shipping-total-cost" and contains(text(),"$10.00")]').isVisible();
