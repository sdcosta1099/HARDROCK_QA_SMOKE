...
test('UH_9521_HALo | Quick Offers | Create a Quick offer with Legend Level', async ({ page }) => {
  ...
  await pa.enterDisplayName('UH_9521')
  await pa.clickOnCardTierRestrictionDropdownQuickOfferSetupPage()
  await pa.selecCardTierRestrictionLegendQuickOfferPage('Legend')
  ...
  await pa.enterOfferNameInSearchBox('UH_9521')
