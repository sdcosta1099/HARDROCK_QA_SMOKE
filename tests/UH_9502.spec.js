...
test('UH_9502_HALo | Quick Offers | Create a Quick Offer For LOB=Casino', async ({ page }) => {
  ...
  await pa.enterDisplayName('UH_9502')
  ...
  await pa.enterOfferNameInSearchBox('UH_9502')
