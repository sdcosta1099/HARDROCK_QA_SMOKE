...
test('UH_9524_HALo | Quick Offers | Create a Quick Offer without Tier Level', async ({ page }) => {
  ...
  await pa.enterDisplayName('UH_9524_Smoke')
  ...
  await pa.enterOfferNameInSearchBox('UH_9524_Smoke')
