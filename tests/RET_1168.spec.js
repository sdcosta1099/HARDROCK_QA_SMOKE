...
test('Guest User PayPal Buy Now | Bag | Tax exempt |', async () => {
  ...
  await pa.selectState({label : 'Delaware'})
  await page.waitForTimeout(3000);
  await pa.enterCity('New Castle')
  await pa.enterPinCode('19720') 
  ...
  await page.locator('//span[@class="tax-total" and contains(text(),"$0.00")]').isVisible();
