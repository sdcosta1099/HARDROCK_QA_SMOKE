...
test('UH-9832 HALO | Events & Offers |Offer Mgmt/Booking Flow -Online Booking Required CTA - ITEMS: Yes | ATTENDEE: Yes | BACKUP: Yes ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9832')
     //login steps
