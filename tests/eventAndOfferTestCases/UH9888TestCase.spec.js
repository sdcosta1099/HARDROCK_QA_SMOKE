...
test('UH-9888 HALO | Events & Offers | Offer Mgmt/Booking Flow - No Booking Required CTA - ITEMS: Yes | ATTENDEE: Yes | BACKUP: No', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9888')
    //login steps
