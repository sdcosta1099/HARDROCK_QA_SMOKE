...
test('UH-9701 HALO | Offer Management | File Upload: Append list of new patrons to event with Different Tiers from Pre-uploaded File', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9701')
      //login steps
