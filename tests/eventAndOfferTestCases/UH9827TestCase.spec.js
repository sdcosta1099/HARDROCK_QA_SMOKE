...
test(' UH-9827 HALO | Events & Offers | Offer Mgmt/Booking Flow - No Booking Required CTA - ITEMS: Yes | ATTENDEE: No | BACKUP: Yes ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9827')
     //login steps
