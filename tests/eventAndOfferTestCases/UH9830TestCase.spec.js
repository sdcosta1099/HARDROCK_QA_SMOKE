...
test('UH-9830 HALO | Events & Offers |Offer Mgmt/Booking Flow - Online Booking CTA - ITEMS: Yes | ATTENDEE: No | BACKUP: No', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9830')
    //login steps
