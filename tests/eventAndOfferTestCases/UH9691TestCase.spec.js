...
test(' UH-9691 HALO | Offer Management | File Upload: Overwrite with file missing Tier and Email column ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9691')
      //login steps
