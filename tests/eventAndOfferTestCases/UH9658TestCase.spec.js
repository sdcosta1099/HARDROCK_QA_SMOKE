...
test(' UH-9658 HALO | Events & Offers | Offer Creation: Create offer with single item', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9658')
    ...
    await gblFuntSteps.loginAdminQA()
     ...
     await configSteps.goToSegmentsPage(1)
