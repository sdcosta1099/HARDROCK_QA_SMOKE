...
test('UH-9703 HALO | Offer Management | File Upload: Remove/Delete Invitee List Not booked to Event ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9703')
     //login steps
