...
test('UH-9831 HALO | Events & Offers | Offer Mgmt/Booking Flow -Online Booking CTA - ITEMS: Yes | ATTENDEE: No | BACKUP: Yes', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9831')
     //login steps
