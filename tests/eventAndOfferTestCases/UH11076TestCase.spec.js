...
test('UH-11076 E2E |Events & Offers | Single Offer | Create, Book and Check-in Offer in Halo and Unity applications with Online Booking CTA', async ({ page }) => {
  ...
  const offerName = gblFuntSteps.randomName('UH11076')
  //login steps
