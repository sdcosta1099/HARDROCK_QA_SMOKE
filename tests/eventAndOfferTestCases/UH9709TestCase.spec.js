...
test('  UH-9709 HALO | Offer Management | File Upload: Change Segment using an Invitee list with pre-uploaded accounts but Empty Tiers ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9709')
     //login steps
