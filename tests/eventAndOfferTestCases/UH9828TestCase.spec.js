...
test('UH-9828 HALO | Events & Offers |Offer Mgmt/Booking Flow - No Booking Required CTA - ITEMS: No | ATTENDEE: Yes | BACKUP: No', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9828')
    //login steps
