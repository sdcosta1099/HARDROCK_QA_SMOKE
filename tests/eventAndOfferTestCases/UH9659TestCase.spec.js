...
test('UH-9659 HALO | Events & Offers | Offer Creation: Validate offers with different segments', async ({ page }) => {
   ...
   const offerName = gblFuntSteps.randomName('UH9659')
   ...
   await gblFuntSteps.loginAdminQA()
    ...
    await configSteps.goToSegmentsPage(10)
