...
test('UH-11927 HALO | EO | File Upload: Remove/Delete Invitee List with mix accounts Booked and Not Booked to Event', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH11927')
    //login steps
