...
test('UH-9693 HALO | Offer Management | File Upload: Overwrite with file missing Acct and Email column', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9693')
     //login steps
