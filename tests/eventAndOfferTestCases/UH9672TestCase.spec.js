...
test('UH-9672 HALO | Events & Offers | Offer Creation: Create offer with single attendee & single item with max qty greater than 1', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9672')
    //login steps
