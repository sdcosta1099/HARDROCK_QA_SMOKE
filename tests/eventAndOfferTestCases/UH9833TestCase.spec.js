...
test('UH-9833 HALO | Events & Offers |Offer Mgmt/Booking Flow -Online Booking CTA - ITEMS: No | ATTENDEE: Yes | BACKUP: Yes ', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9833')
    //login steps
