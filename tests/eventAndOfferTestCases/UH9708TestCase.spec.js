...
test('UH-9708 HALO | Offer Management | File Upload: Change Segment using List with a mix accounts booked and NOT booked to Event but different Segment ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9708')
      //login steps
