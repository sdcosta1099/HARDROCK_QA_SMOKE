...
test(' UH-9702 HALO | Offer Management | File Upload: Remove/Delete Invitee List with mix accounts Booked and Not Booked to Event ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9702')
      //login steps
