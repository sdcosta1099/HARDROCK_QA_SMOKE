...
test(' UH-9695 HALO | Offer Management | File Upload: Overwrite existing upload with invalid file format ', async ({ page }) => {
  ...
  const offerName = gblFuntSteps.randomName('UH9695')
  //login steps
