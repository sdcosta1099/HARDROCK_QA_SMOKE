...
test('UH-9826 HALO | Events & Offers | Offer Mgmt/Booking Flow - No Booking Required CTA - ITEMS: Yes | ATTENDEE: No | BACKUP: No', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9826')
     //login steps
