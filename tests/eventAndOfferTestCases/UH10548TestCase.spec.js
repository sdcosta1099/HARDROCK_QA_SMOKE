...
test(' UH-10548 Halo | Cancel reservation of event&offer and Validate Player transaction in Halo ', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH10548')
    //login steps
