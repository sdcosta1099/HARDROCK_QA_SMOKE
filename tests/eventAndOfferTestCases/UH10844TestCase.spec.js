...
test('UH-10844 HALO|Event & Offers|Cancel Reservation|Verify if Invited Patron when cancel the offer should return to Events and Offers', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH10844')
     //login steps
