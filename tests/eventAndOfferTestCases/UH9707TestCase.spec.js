...
test('UH-9707 HALO | Offer Management | File Upload: Change Segment using Invitee List with accounts booked to Event but different Segment ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9707')
      //login steps
