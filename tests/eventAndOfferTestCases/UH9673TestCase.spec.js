...
test('UH-9673 HALO | Events & Offers | Offer Creation: Create offer with single attendee & single item with max qty of 1', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9673')
      //login steps
