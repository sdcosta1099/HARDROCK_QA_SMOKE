...
test('UH-9829 HALO | Events & Offers |Offer Mgmt/Booking Flow -No Booking Required CTA - ITEMS: Yes | ATTENDEE: Yes | BACKUP: Yes', async ({ page }) => {
 ...
 const offerName = gblFuntSteps.randomName('UH9829')
 //login steps
