...
test('UH-9687 HALO | Offer Management | File Upload: Overwrite blank file after trying to add a file', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9687')
      //login steps
