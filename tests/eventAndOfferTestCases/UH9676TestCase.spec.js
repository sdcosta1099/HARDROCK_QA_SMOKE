...
test('UH-9676 HALO | Events & Offers | Offer Creation: Create offer with multiple items and attendees', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9676')
      //login steps
