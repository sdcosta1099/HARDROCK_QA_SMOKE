...
test('UH-9704  HALO | Offer Management | File Upload: Remove/Delete Invitee List booked/Checked-in to Event', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9704')
     //login steps
