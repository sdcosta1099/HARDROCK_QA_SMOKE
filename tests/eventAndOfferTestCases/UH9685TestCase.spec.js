...
test(' UH-9685 HALO | Offer Management | File Upload: Append list of new patrons to event with Same Tiers as Pre-uploaded File ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
       ...
       const offerName = gblFuntSteps.randomName('UH9685')
       //login steps
