...
test('UH-9671 Events & Offers | Offer Creation: Create offer with single attendee & multiple items with max qty of 1', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9671')
    //login steps
