...
test('UH-9675 HALO | Events & Offers | Offer Creation: Create offer with multiple attendees & single item with max qty of 1', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9675')
      //login steps
