...
test('UH-9674 HALO | Events & Offers | Offer Creation: Create offer with multiple attendees and max qty of 1', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9674')
      //login steps
