...
test('UH-9700 HALO | Offer Management | File Upload: Overwrite existing with file a file that has column headers and no patrons', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH96700')
      //login steps
