...
test('UH-9684 HALO | Offer Management | File Upload: Append file with mix of patrons with Tiers and Non Tiers ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
       ...
       const offerName = gblFuntSteps.randomName('UH9684')
       //login steps
