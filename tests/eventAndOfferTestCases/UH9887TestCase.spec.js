...
test('UH-9887 HALO | Events & Offers | Offer Mgmt/Booking Flow - Online Booking CTA - ITEMS: Yes | ATTENDEE: Yes | BACKUP: No', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9887')
     //login steps
