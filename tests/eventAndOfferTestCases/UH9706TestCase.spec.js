...
test('UH-9706 HALO | Offer Management | File Upload: Change Segment using an Invitee list with pre-uploaded accounts but different Segment ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9706')
      //login steps
