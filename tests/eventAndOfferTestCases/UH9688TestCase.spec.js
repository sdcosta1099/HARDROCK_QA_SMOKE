...
test(' UH-9688 HALO | Offer Management | File Upload: Append invalid format file after successful upload', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9688')
    //login steps
