...
test('UH-9838 HALo|Check-In|Test| Check In - Items: YES | Attendance: NO | Backup: NO - Single item - Inv. Avail. - Booked in Advance', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9838')
     //login steps
