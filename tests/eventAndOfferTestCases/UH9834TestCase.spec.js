...
test(' UH-9834 HALO | Events & Offers |Offer Mgmt/Booking Flow - No Booking Required CTA - ITEMS: No | ATTENDEE: Yes | BACKUP: Yes ', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9834')
     //login steps
