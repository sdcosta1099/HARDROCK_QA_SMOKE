...
test(' UH-9683 HALO | Offer Management | File Upload: Append list of already invited patrons to event', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9683')
     //login steps
