...
test(' UH-10547 Halo | Modify Booked event&offer through override and Validate Player transaction in Halo', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH10547')
    //login steps
