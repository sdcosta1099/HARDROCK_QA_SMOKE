...
test('UH-9667 HALO | Events & Offers | Search Offers: Filter offers by Type', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9667')
     ...
     await gblFuntSteps.loginAdminQA()
      ...
      await configSteps.locateOfferByAllType(offerName, typeName)
