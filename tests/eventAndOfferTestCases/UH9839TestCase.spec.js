...
test('UH-9839 HALo|Check-In|Test|Check In - Items: YES | Attendance: NO | Backup: NO - Single item - Inv. Avail < max. quantity - Not booked in advance ', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9839')
    //login steps
