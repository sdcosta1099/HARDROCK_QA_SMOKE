...
test('UH-9664 HALO | Events & Offers | Offer Creation: Create offer with multiple attendee', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9664')
    ...
    await gblFuntSteps.loginAdminQA()
     ...
     await configSteps.goToAttendeeCapacityPage('NO', 50)
     await configSteps.goToSegmentsPage(2)
     await configSteps.goToCheckInPage(ye,no)
