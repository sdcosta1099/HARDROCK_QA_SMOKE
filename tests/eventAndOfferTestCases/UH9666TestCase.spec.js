...
test('UH-9666 HALo | Events & Offers | Search Offers: Filter offers by Property ', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9666')
    ...
    await configSteps.locateOfferByProperty('Hard Rock Hollywood')
