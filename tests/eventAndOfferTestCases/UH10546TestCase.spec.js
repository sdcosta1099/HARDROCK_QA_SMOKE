...
test('UH-10546 Halo | Modify Booked event&offer for invited player and Validate Player transaction in Halo ', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH10546')
    //login steps
