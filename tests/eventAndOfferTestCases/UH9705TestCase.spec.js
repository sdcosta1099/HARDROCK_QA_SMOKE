...
test('UH-9705 HALO | Offer Management | File Upload: Remove/Delete Invitee List with mix accounts Booked and Not Booked to Event', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
      ...
      const offerName = gblFuntSteps.randomName('UH9705')
      //login steps
