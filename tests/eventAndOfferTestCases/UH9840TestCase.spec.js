...
test('UH-9840 HALo|Check-In|Test|Check In - Items: YES | Attendance: NO | Backup: NO - Single item - Inv. Avail. < qty. booked - Booked in Advance', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9840')
    //login steps
