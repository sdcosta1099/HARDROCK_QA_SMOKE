...
test('UH-9835 HALO | Events & Offers | Offer Mgmt/Booking Flow - Online Booking CTA - ITEMS: No | ATTENDEE: Yes | BACKUP: No ', async ({ page }) => {
    ...
    const offerName = gblFuntSteps.randomName('UH9835')
    //login steps
