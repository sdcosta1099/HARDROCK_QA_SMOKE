...
test('UH-9665 HALO | Events & Offers | Offer Management: Search Offers: Search for offer by name', async ({ page }) => {
    ...
    const configSteps = new configurationSteps(page)
     ...
     const offerName = gblFuntSteps.randomName('UH9665')
     ...
     await gblFuntSteps.loginAdminQA()
      ...
      await configSteps.searchApprovedOffer(offerName)
