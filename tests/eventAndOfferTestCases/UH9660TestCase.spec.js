...
test('UH-9660 HALO | Events & Offers | Offer Creation: Create & Validate offer w/o check-in', async ({ page }) => {
   ...
   const offerName = gblFuntSteps.randomName('UH9660')
   ...
   await gblFuntSteps.loginAdminQA()
    ...
    await configSteps.goToCheckInPage(NO,no)
    ...
    await configSteps.validateEventCheckIn(offerName)
