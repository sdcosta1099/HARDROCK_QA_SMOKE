...
test('  UH-10513 CMP | Halo | Void Comment from CMP and Validate Player transaction in Halo', async ({ page }) => {
    ...
    console.log("Void Comment on CMP then run test to validate comment on Halo")

    await gblFuntSteps.gotoQALoginPage()
    await gblFuntSteps.loginAdminQA()
    await searchPlayerID.searchPlayerID(testData.CommentTestAccounts.UH10513)
