...
test('UH_9446_HALO | Events & Offers | HALO | Events and Offers | Create offer with No Booking', async ({ page }) => {
  ...
  await pa.SelectfillOutNewEventFields4("UH__9446")
  ...
  await pa.enterOfferName("UH__9446")
  ...
  await pa.searchOfferFromViewEventsAndOffer('UH__9446')
