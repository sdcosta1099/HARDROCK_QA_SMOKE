...
test('UH-10566  Player Transactions Player Transactions PII masking User validation', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10566)
