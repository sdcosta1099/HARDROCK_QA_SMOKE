...
test.skip('UH-10510 CMP| Halo |  Update Player Type from CMP and Validate Player transaction in Halo', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10510)
