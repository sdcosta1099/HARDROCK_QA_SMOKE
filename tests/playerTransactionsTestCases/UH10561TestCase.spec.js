...
test('UH-10561  HALO | Player Transactions Component Display validation', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10561)
