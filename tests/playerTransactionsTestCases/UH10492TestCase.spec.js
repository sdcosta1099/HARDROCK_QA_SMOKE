...
test('UH-10492 CMP | Halo | Update or modify Email Address from CMP and Validate Player transaction in Halo ', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10492)
