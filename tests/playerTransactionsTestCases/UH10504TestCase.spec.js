...
test.skip('UH-10504  CMP | Halo | Update/Modify Home mailing Address from CMP and Validate Player transaction in Halo', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10504)
