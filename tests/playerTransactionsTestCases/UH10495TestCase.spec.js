...
test('UH-10495 CMP| Halo | Add Email Address from CMP and Validate Player transaction in Halo', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10495)
