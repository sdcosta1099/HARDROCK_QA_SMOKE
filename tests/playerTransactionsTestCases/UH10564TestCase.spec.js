...
test('UH-10564 HALO | Player Transactions Search validation ', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10564)
