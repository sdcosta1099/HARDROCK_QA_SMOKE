...
test('UH-10491 HALO | Offer Management | File Upload: Remove/Delete Invitee List booked/Checked-in to Event ', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10491)
