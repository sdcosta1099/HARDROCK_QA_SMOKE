...
test('UH-10560 HALO | Player Transactions Display validation', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10560)
