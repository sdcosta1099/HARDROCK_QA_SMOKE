...
test('UH-10499 Add Home mailing Address from CMP and Validate Player transaction in Halo ', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10499)
