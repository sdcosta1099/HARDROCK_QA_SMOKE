...
test.skip('UH-10501 CMP| Halo | Remove/delete Alternate mailing Address from CMP and Validate Player transaction in Halo ', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.playerTransactionsTestAccounts.UH10501)
