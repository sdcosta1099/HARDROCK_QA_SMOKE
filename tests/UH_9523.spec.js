...
test('UH_9523_HALo | Quick Offers | Create a Quick Offer with multiple LOB', async ({ page }) => {
  ...
  await pa.checkHotelOptionOfLobQuickOfferSetupPage('Hotel')
  await pa.clickOnLobDropdownQuickOfferPage()
  ...
  await pa.checkHardRockAtlanticCityOptionDisplayPropertyQuickOffer('Hard Rock Atlantic City')
  await pa.checkHardRockNorthernIndianaOptionDisplayPropertyQuickOffer('Hard Rock Northern Indiana')
  await pa.clickOnDisplayLocationDropdown()
  await pa.checkOptionOfDisplayLocationQuickOfferSetupPage('Location 71')
  await pa.enterDisplayName('UH_9523')
  ...
  await pa.enterOfferNameInSearchBox('UH_9523')
