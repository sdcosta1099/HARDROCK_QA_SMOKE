...
test('UH-10430 HALO | Comm Preferences | Verify Selecting "Unsubscribe from All" Email button', async ({ page }) => {
    ...
    await searchPlayerID.searchPlayerID(testData.commPreferencesTestAccounts.UH10430)
    //await page.pause()
