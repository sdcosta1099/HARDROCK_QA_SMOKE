...
test('UH_9449_HALO | Events & Offers | Booking | Book invited Patron', async ({ page }) => {
  ...
  await pa.SelectfillOutNewEventFields4("Smoke_UH_9449")
  ...
  await pa.enterOfferName("Smoke_UH_9449")
  ...
  await pa.searchOfferFromViewEventsAndOffer('Smoke_UH_9449')
