...
test('UH_9454 HALO | Events & Offers | Check-In | Non Invited Patron Not Booked', async ({ page }) => {
  ...
  await pa.SelectfillOutNewEventFields4("Smoke_UH_9454")
  ...
  await pa.enterOfferName("Smoke_UH_9454")
  ...
  await pa.searchEventInCheckin('Smoke_UH_9454')
  await pa.selectEventInCheckin('Smoke_UH_9454')
  await pa.enterPatronInEventCheckinAndSearch('807651714')
  await pa.validatePatronWasNotInvitedPopup();
  await pa.addPatronToEvent()
  await pa.validateOverridereasonApproverusernameApproverpassword()
  await pa.enterOverRideDetailsAndOverRide('Testing Functionality','TU_LAB_HALO_NIN_ADM','Password01@$')
