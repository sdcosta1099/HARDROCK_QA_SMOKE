...
test('UH_9433_HALo | Configuration | Events & Offers | Quick Offers | Deactivate Quick Offer', async ({ page }) => {
  ...
  await pa.enterDisplayName('UH_9433_Smoke')
  ...
  await pa.enterOfferNameInSearchBox('UH_9433_Smoke')
  await pa.clickOnSearchForQuickOffer()
  await pa.validateOfferCreated3Displayed()
  ...
  await pa.enterEventOfferNameInSearchBox('UH_9433_Smoke')
